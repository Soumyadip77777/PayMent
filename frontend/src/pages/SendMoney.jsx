...
export const SendMoney = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#0f0f0f] to-[#050505] text-white">
            <ToastContainer />
            <div className="w-full max-w-md bg-[#111] rounded-2xl shadow-2xl px-8 py-10 space-y-6 border border-[#2e2e2e]">
                ...
                <button
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-md transition text-sm font-medium"
                >
                    Send ₹{amount || 0}
                </button>
